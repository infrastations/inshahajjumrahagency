          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 space-y-6 border border-white/20 shadow-2xl">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <p className="text-white text-sm font-body">Shariah Consultants</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-white text-sm font-body">Special Days</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-white text-sm font-body">Umrah Guides</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-white text-sm font-body">Business Associates</p>
              </div>
            </div>
